...
export default function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-[760px] px-4 py-12">
      <h1 className="text-3xl font-extrabold text-text mb-6">Tentang 352.IDN</h1>
      <div className="space-y-4 text-text-secondary leading-relaxed">
        ...
        <h2 className="text-xl font-bold text-text mt-8">Fokus Editorial</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-text mt-8">Topik Liputan</h2>
