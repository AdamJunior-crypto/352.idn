...
export default function PrivacyPage() {
  ...
  return (
    <div className="mx-auto max-w-[760px] px-4 py-12">
      <h1 className="text-3xl font-extrabold text-text mb-6">Privacy Policy</h1>
      <div className="space-y-4 text-text-secondary leading-relaxed">
        <h2 className="text-xl font-bold text-text">Data yang Dikumpulkan</h2>
        ...
        <h2 className="text-xl font-bold text-text mt-8">Cookie</h2>
        ...
        <h2 className="text-xl font-bold text-text mt-8">Analytics</h2>
        <p>Kami menggunakan layanan analitik pihak ketiga untuk memahami bagaimana website digunakan.</p>
        <h2 className="text-xl font-bold text-text mt-8">Hak Pengguna</h2>
